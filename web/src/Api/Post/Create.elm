module Api.Post.Create exposing (Request, Response(..), request)
...
responseInnerDecoder tag =
    case tag of
        ...
        _ ->
            D.fail <| "Encountered unknown tag `" ++ tag ++ "` while decoding Post.Create.Response"
