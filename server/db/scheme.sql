...
CREATE DATABASE IF NOT EXISTS `kotoba` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `kotoba`;
...
CREATE TABLE `files` (
  ...
  `extension` enum('jpeg','png','webp','mp3','mp4') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `size` int NOT NULL,
